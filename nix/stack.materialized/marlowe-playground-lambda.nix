{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "marlowe-playground-lambda"; version = "0.1.0.0"; };
      license = "Apache-2.0";
      copyright = "";
      maintainer = "";
      author = "David Smith";
    ...
    components = {
      ...
      exes = {
        "marlowe-playground-lambda" = {
          depends = [
            ...
            (hsPkgs."lens" or (errorHandler.buildDepError "lens"))
            (hsPkgs."marlowe" or (errorHandler.buildDepError "marlowe"))
            (hsPkgs."marlowe-playground-lambda" or (errorHandler.buildDepError "marlowe-playground-lambda"))
            (hsPkgs."marlowe-symbolic" or (errorHandler.buildDepError "marlowe-symbolic"))
            (hsPkgs."marlowe-actus" or (errorHandler.buildDepError "marlowe-actus"))
            (hsPkgs."monad-logger" or (errorHandler.buildDepError "monad-logger"))
            (hsPkgs."mtl" or (errorHandler.buildDepError "mtl"))
      ...
      tests = {
        "marlowe-playground-lambda-test" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
    ...
    src = (pkgs.lib).mkDefault ./marlowe-playground-lambda;
    }